document.addEventListener('DOMContentLoaded', _ => {
    hljs.registerLanguage('nessa', function () {
        return {
            ...
            keywords: {
                keyword: 'if else for in while fn op return syntax type class let unary binary nary prefix postfix right from to op interface implement import expr block do',
                literal: ['false', 'true'],
            },
            contains: [
                {
