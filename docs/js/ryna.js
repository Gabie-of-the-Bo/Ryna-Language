document.addEventListener('DOMContentLoaded', _ => {
    hljs.registerLanguage('ryna', function () {
        return {
            ...
            keywords: {
                keyword: 'if else for in while fn op return syntax int type class let unary binary nary prefix postfix right from to op interface implement import expr block do break continue',
                literal: ['false', 'true'],
            },
            contains: [
                {
